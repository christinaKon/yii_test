...
$this->title = 'My profile expert';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="site-my-profile-expert">
            ...
            <div class="my-profile">
              ...
              <div class="my-profile__right_col">
                ...
                <div class="my-profile__theme_wrapper">
                  <span class="grey-text">Мои темы</span>
                ...
                <div class="my-profile__block_wrapper">
                  ...
                  <div class="my-profile__block">
                    <div class="my-profile__block_inner">
                      ...
                      <div class="my-profile__block_status grey-text"><i class="material-icons">verified_user</i>Подтверждено</div>
                    </div>
                  </div>
                </div>
                <div class="my-profile__statistic_wrapper">
                ...
                <div class="my-profile__press_release_wrapper">
                  <div class="grey-text">Мои пресс-релизы.</div>
                  <div class="my-profile__press_release">Гаджеты для ресторанов: вкусная еда или высокие технологии?</div>
                  <div class="my-profile__press_release">Кому выгоден энергоэффективный капремонт</div>
                  <div class="my-profile__press_release">Россияне выбирают каркасно-панельные дома</div>
                  <div class="my-profile__press_release">Фабрика новостей</div>
                </div>
              </div>
            </div>
          </div>
