<aside class="sidebar">
  <ul class="sidebar__list">
    <li class="sidebar__item active"><a href="#"><i class="material-icons">email</i>Все запросы</a></li>
    <li class="sidebar__item"><a href="#"><i class="material-icons">chat_bubble_outline</i>Мои ответы</a></li>
